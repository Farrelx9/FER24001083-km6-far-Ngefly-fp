      ...
      <div className="flex justify-between gap-3 px-3 md:px-10 lg:px-32">
        ...
        {!isLoggedIn ? (
          ...
          <div className="flex gap-4 mr-2 items-center">
            <MdOutlineList size={25} onClick={() => navigate("/history")} className="cursor-pointer" />
            <div className="relative">
            <MdNotificationsNone size={25} onClick={() => navigate("/notif")} className="cursor-pointer" />
            {localUnreadCount > 0 && (
            ...
            <FiUser size={25} onClick={() => navigate("/profile")} className="cursor-pointer" />
          </div>
        )}
      </div>
    </div>
